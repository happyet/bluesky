...
function twentytwelve_header_style() {
	...
	<?php
		...
		if ( !empty( $header_image ) ) :
	?>
		#logo a.imglogo{width:<?php echo get_custom_header()->width; ?>px;height:<?php echo get_custom_header()->height; ?>px;background:url(<?php echo esc_url( $header_image ); ?>) no-repeat;text-indent:-999em;}
	<?php endif; ?>
	</style>
	<?php
}
